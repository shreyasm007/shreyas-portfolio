        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a href={`#${link.to}`} className="hover:text-blue-400 transition-colors">{link.name}</a>
                </li>
              ))}
            </ul>
          </motion.div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <p className="flex items-center">
                  ...
                  <a href={`mailto:${personalInfo.email}`} className="ml-2 hover:text-blue-400 transition-colors">
                    {personalInfo.email}
                  </a>
                </p>
              </li>
              <li>
                <p className="flex items-center">
                  ...
                  <a href={`tel:${personalInfo.phone.replace(/\s/g, '')}`} className="ml-2 hover:text-blue-400 transition-colors">
                    {personalInfo.phone}
                  </a>
                </p>
              </li>
